...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterDoctrine
{
  ...
  public function addDeevoThemesListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    if (!is_array($values))
    {
      $values = array($values);
    ...
    $query
      ...
      ->andWhereIn('DeevoThemeUser.deevo_theme_id', $values)
    ;
  }
