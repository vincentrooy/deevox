...
/**
 * ProductIndex form base class.
 *
 * @method ProductIndex getObject() Returns the current form's model object
 *
 * @package    deevox
 * @subpackage form
 ...
 */
abstract class BaseProductIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('product_index[%s]');
