...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'C:\\Users\\Vincent Talla\\deevox\\log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'C:\\Users\\Vincent Talla\\deevox\\cache\\frontend\\dev\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'C:\\Users\\Vincent Talla\\deevox\\apps\\frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\Users\\Vincent Talla\\deevox\\cache\\frontend\\dev\\template',
  'lifetime' => 86400,
  'prefix' => 'C:\\Users\\Vincent Talla\\deevox\\apps\\frontend/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    array (
      ...
      'port' => 465,
      'encryption' => 'ssl',
      'username' => 'vincent.fonkoua@gmail.com',
      'password' => 'neptune4375',
    ),
  ),
))));
